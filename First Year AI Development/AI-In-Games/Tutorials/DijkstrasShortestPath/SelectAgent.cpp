...
{
	DistanceCondition* closerThan5 = new DistanceCondition(5.0f * GetNodeMap()->GetCellSize(), true);
	DistanceCondition* futherThan7 = new DistanceCondition(5.0f * GetNodeMap()->GetCellSize(), false);
