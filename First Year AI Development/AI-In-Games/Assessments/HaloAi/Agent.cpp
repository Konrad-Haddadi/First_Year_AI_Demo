...
Agent::Agent(const char* _name, NodeMap* _map, Behaviour* _behaviour, int _speed, Color _color, GameStateManager* _gsMan, GameObjectManager* _goMan)
	: GameObject(_name, _gsMan, _goMan), m_map(_map), m_behaviour(_behaviour), m_pathAgent(_map, _speed, _color), m_spartan(nullptr), m_next(nullptr)
{
